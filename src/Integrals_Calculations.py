...
plt.grid(True)
plt.title('Left Rectangle Rule Errors', fontsize = 14 , fontweight="bold")
...
plt.grid(True)
plt.title('Maximum Error calculated by Left Rectangle Error Rule', fontsize = 14 , fontweight="bold")
plt.xlabel('Step Size', fontweight="bold")
plt.ylabel('Error', fontweight="bold")
...
plt.grid(True)
plt.title('Right Rectangle Rule Errors', fontsize = 14 , fontweight="bold")
plt.xlabel('Step Size', fontweight="bold")
plt.ylabel('Error', fontweight="bold")
...
plt.grid(True)
plt.title('Maximum Error calculated by Right Rectangle Error Rule', fontsize = 14 , fontweight="bold")
plt.xlabel('Step Size', fontweight="bold")
plt.ylabel('Error', fontweight="bold")
...
plt.grid(True)
plt.title('Trapezoidal Rule Errors', fontsize = 14 , fontweight="bold")
plt.xlabel('Step Size', fontweight="bold")
plt.ylabel('Error', fontweight="bold")
...
plt.grid(True)
plt.title('Maximum Error calculated by Trapezoidal Error Rule', fontsize = 14 , fontweight="bold")
plt.xlabel('Step Size', fontweight="bold")
plt.ylabel('Error', fontweight="bold")
...
plt.grid(True)
plt.title('Simpson Rule Errors', fontsize = 14 , fontweight="bold")
plt.xlabel('Step Size', fontweight="bold")
plt.ylabel('Error', fontweight="bold")
...
plt.grid(True)
plt.title('Maximum Error calculated by Simpson Error Rule', fontsize = 14 , fontweight="bold")
plt.xlabel('Step Size', fontweight="bold")
plt.ylabel('Error', fontweight="bold")
